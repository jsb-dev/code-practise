...
1) When two instances of this class are added together with the + operator, 
the resulting value is the sum of all the elements in both arrays.
2) When the String() function is called on the instance, it will return a comma 
...
var ArrayWrapper = function (nums) {
  if (nums.length > 1000) {
    throw new Error('nums.length must be <= 1000');
  }
  this.arr = nums;
};
